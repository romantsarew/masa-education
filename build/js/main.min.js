...
var _burgerInit = require("./modules/burger/burger-init");
var _swiperInit = require("./modules/swiper/swiper-init");
var _customSelect = require("./modules/select/custom-select");
var _initAccordion = require("./modules/accordion/init-accordion");
var _mapInit = require("./modules/map/map-init");
var _newsButtonInit = require("./modules/button/news-button-init");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _burgerInit.burgerMenuInit)();
  (0, _swiperInit.swiperIntroInit)();
  (0, _swiperInit.swiperProgramsInit)();
  (0, _swiperInit.swiperNewsInit)();
  (0, _initAccordion.initAccordions)();
  (0, _swiperInit.swiperNewsControlsInit)();
  (0, _swiperInit.swiperOpinionsInit)();
  (0, _mapInit.mapInit)();
  (0, _newsButtonInit.controlButtonsToggle)();
...
},{"./modules/accordion/init-accordion":3,"./modules/burger/burger-init":4,"./modules/button/news-button-init":5,"./modules/form-validate/form":7,"./modules/map/map-init":13,"./modules/modals/init-modals":14,"./modules/select/custom-select":17,"./modules/swiper/swiper-init":19,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";
...
function burgerMenuInit() {
  ...
  var navSublists = document.querySelectorAll('.header__nav-sublist');
  var firstMenuItem = navMain.querySelector('.header__nav-list a');
  ...
  navLinks.forEach(function (link) {
    link.addEventListener('click', function (event) {
      if (link.classList.contains('header__nav-link')) {
        ...
        var listItem = link.closest('.header__nav-item');
        if (listItem) {
          var sublist = listItem.querySelector('.header__nav-sublist');
          if (sublist) {
...
exports.controlButtonsToggle = controlButtonsToggle;
var controlButtons = document.querySelectorAll('.news__control');
...
function mapInit() {
  ...
  if (mapElement) {
    ...
    }).setView([55.028343, 82.927639], 15);
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      setTimeout(function () {
        ...
        var modalNameInput = modal.querySelector('#modal-name');
        if (modalNameInput) {
...
exports.swiperIntroInit = swiperIntroInit;
exports.swiperNewsControlsInit = swiperNewsControlsInit;
exports.swiperNewsInit = swiperNewsInit;
exports.swiperOpinionsInit = swiperOpinionsInit;
exports.swiperProgramsInit = swiperProgramsInit;
/* eslint-disable no-undef */
/* eslint-disable no-unused-vars */
var introSlider = document.querySelector('.intro__swiper');
var programsSlider = document.querySelector('.programs__slider');
var newsSlider = document.querySelector('.news__swiper');
var newsControlsSlider = document.querySelector('.news__controls-swiper');
var opinionsSlider = document.querySelector('.opinions__slider');
...
function swiperProgramsInit() {
  if (programsSlider) {
    var swiper = new Swiper(programsSlider, {
      slidesPerView: 3,
      cssMode: true,
      direction: 'horizontal',
      loop: false,
...
function swiperNewsControlsInit() {
  if (newsControlsSlider) {
    var swiper = new Swiper(newsControlsSlider, {
      cssMode: true,
      direction: 'horizontal',
      loop: false,
...
function swiperOpinionsInit() {
  if (opinionsSlider) {
    var swiper = new Swiper(opinionsSlider, {
      cssMode: true,
      direction: 'horizontal',
      loop: false,
      breakpoints: {
