...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _mapInit.mapInit)();
  (0, _checkbox.checkboxStatusChecking)();
...
},{"./modules/accordion/init-accordion":3,"./modules/burger/burger-init":4,"./modules/checkbox/checkbox":5,"./modules/form-validate/form":7,"./modules/map/map-init":13,"./modules/modals/init-modals":14,"./modules/select/custom-select":17,"./modules/swiper/swiper-init":19,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";
...
function burgerMenuInit() {
  ...
  var navSublists = document.querySelectorAll('.header__nav-sublist--closed');
  ...
  navLinks.forEach(function (link) {
    link.addEventListener('click', function (event) {
      if (link.classList.contains('header__nav-link')) {
        ...
        if (listItem) {
          var sublist = listItem.querySelector('.header__nav-sublist--closed');
          if (sublist) {
...
exports.checkboxStatusChecking = checkboxStatusChecking;
function checkboxStatusChecking() {
  var personalCheckbox = document.getElementById('personal');
  var errorText = document.querySelector('.feedback__check-error');
